  ...
  return (
    <div className="min-h-screen bg-gray-50 px-6 py-10">
      <div className="max-w-3xl mx-auto">
        <h1 className="text-xl font-bold text-brand-700 mb-6">Find developers</h1>
        ...
        {data && data.developers.length === 0 && (
          <p className="text-gray-400 text-sm">No developers matched those filters.</p>
        )}
        ...
        {data && data.total > data.pageSize && (
          <div className="flex items-center justify-center gap-4 mt-8 text-sm">
            <button
              ...
              className="text-brand-600 disabled:text-gray-300 disabled:cursor-not-allowed"
            >
              ← Previous
            </button>
