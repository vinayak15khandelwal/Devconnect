...
export default function NotificationBell() {
    ...
    return (_jsxs("div", { className: "relative", ref: containerRef, children: [_jsxs("button", { onClick: () => setOpen((v) => !v), "aria-label": "Notifications", className: "relative w-9 h-9 flex items-center justify-center rounded-md border border-gray-200 dark:border-gray-700 text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 transition", children: [_jsxs("svg", { xmlns: "http://www.w3.org/2000/svg", width: "18", height: "18", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", children: [_jsx("path", { d: "M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9" }), _jsx("path", { d: "M13.73 21a2 2 0 0 1-3.46 0" })] }), unreadCount > 0 && (_jsx("span", { className: "absolute -top-1 -right-1 bg-red-500 text-white text-[10px] font-bold rounded-full w-4 h-4 flex items-center justify-center", children: unreadCount > 9 ? "9+" : unreadCount }))] }), open && (_jsxs("div", { className: "absolute right-0 mt-2 w-80 max-h-96 overflow-y-auto bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 rounded-lg shadow-lg z-20", children: [_jsx("div", { className: "px-4 py-2 border-b border-gray-100 dark:border-gray-700 text-sm font-semibold text-gray-700 dark:text-gray-300", children: "Notifications" }), (!notifications || notifications.length === 0) && (_jsx("p", { className: "px-4 py-6 text-sm text-gray-400 dark:text-gray-500 text-center", children: "No notifications yet." })), notifications?.map((n) => (_jsxs("div", { onClick: () => !n.read && markRead.mutate(n.id), className: "px-4 py-3 border-b border-gray-50 dark:border-gray-700/50 last:border-0 flex items-start gap-3 cursor-pointer " +
